...
" The dark.vim theme:
let s:airline_a_normal   = [ '#ffffff' , '#444444' , 255 , 238 ]
let s:airline_b_normal   = [ '#00005f' , '#dfff00' , 17  , 190 ]
...
let s:airline_b_insert = [ '#00005f' , '#00dfff' , 17  , 45  ]
let s:airline_a_insert = [ '#ffffff' , '#005fff' , 255 , 27  ]
