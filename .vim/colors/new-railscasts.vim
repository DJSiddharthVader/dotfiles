...
hi Cursor                    guifg=#000000 guibg=#FFFFFF ctermfg=1 ctermbg=5
hi iCursor                    guifg=#000000 guibg=#FFFFFF ctermfg=1 ctermbg=5
hi CursorLine                guibg=#282828 ctermbg=236 cterm=NONE
hi Search                    guifg=#FFC66D guibg=#072f95 gui=bold ctermbg=39
hi IncSearch                    guifg=#FFC66D guibg=#072f95 gui=bold ctermbg=39
"hi Visual                    guibg=#004568 ctermbg=60
hi Visual                    guibg=#004568 ctermbg=237
hi LineNr                    guifg=#707070 guibg=#2d2d2d  ctermfg=242
"bottom bars
hi StatusLine                guifg=#e4e4e4 guibg=#606060 gui=NONE ctermfg=234 ctermbg=146 cterm=NONE
hi StatusLineNC              guifg=#585858 guibg=#303030 gui=NONE ctermfg=59 ctermbg=236 cterm=NONE
hi ModeMsg ctermfg=3
"tab coloring
hi TabLine ctermbg=247
hi TabLineFill ctermfg=247
...
hi ColorColumn               guibg=#333435 ctermbg=1
...
" Folds
" -----
hi Folded                    guifg=#F6F3E8 guibg=#444444 gui=NONE ctermbg=23
...
hi Comment                   guifg=#212121 guibg=NONE gui=italic ctermfg=243
...
" Spell
" ----
hi SpellBad                  guibg=#420101 gui=NONE guisp=red ctermbg=9
